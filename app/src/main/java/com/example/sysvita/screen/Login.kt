...
fun LoginScreen(navController: NavHostController) {
    ...
    Box(
        ...
        Column(
            ...
            // Logo
            Image(
                painter = painterResource(id = R.drawable.logo), // Asegúrate de que 'logo.png' esté en res/drawable
                    ...
                    when {
                        ...
                        !validatePassword(password) -> {
                            ...
                            coroutineScope.launch {
                                isLoading = true
                                val response:ApiResponse = userRepository.loginUser(user)
                                    ...
                                    if (response.success) {
                                        if (response.data != null) {
                                            ...
                                            navController.navigate(
                                                Screen.Home.route + "/${response.data.username}/" +
                                                        "${response.data.direccion}/${response.data.email}"
                                            )
                                        } else {
